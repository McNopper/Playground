#ifndef ENGINE_RENDERER_GEOMETRY_SURFACE_TRIANGLEMESH_H_
#define ENGINE_RENDERER_GEOMETRY_SURFACE_TRIANGLEMESH_H_
...
#endif /* ENGINE_RENDERER_GEOMETRY_SURFACE_TRIANGLEMESH_H_ */
