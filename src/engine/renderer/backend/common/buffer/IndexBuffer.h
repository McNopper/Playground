#ifndef ENGINE_RENDERER_BACKEND_COMMON_BUFFER_INDEXBUFFER_H_
#define ENGINE_RENDERER_BACKEND_COMMON_BUFFER_INDEXBUFFER_H_
...
#endif /* ENGINE_RENDERER_BACKEND_COMMON_BUFFER_INDEXBUFFER_H_ */
