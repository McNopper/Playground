#ifndef RENDERER_BACKEND_COMMON_BUFFER_UNIFORMBUFFER_H_
#define RENDERER_BACKEND_COMMON_BUFFER_UNIFORMBUFFER_H_
...
#endif /* RENDERER_BACKEND_COMMON_BUFFER_UNIFORMBUFFER_H_ */
