#ifndef ENGINE_RENDERER_BACKEND_COMMON_BUFFER_DESCRIPTORBUFFER_H_
#define ENGINE_RENDERER_BACKEND_COMMON_BUFFER_DESCRIPTORBUFFER_H_
...
#endif /* ENGINE_RENDERER_BACKEND_COMMON_BUFFER_DESCRIPTORBUFFER_H_ */
