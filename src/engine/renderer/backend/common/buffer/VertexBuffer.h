#ifndef ENGINE_RENDERER_BACKEND_COMMON_BUFFER_VERTEXBUFFER_H_
#define ENGINE_RENDERER_BACKEND_COMMON_BUFFER_VERTEXBUFFER_H_
...
#endif /* ENGINE_RENDERER_BACKEND_COMMON_BUFFER_VERTEXBUFFER_H_ */
